...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[INFORMACIÓN] 𝐼𝑁𝐺𝑅𝐸𝑆𝐸 𝑈𝑁 𝐸𝑁𝐿𝐴𝐶𝐸 𝐷𝐸 𝐼𝑁𝑆𝑇𝐴𝐺𝑅𝐴𝑀, 𝐸𝐽𝐸𝑀𝑃𝐿𝑂: ${usedPrefix + command}* https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link`;
  m.reply(global.wait);
  try {
