...
else conn.sendButton(m.chat, `\n${wm}`, lenguajeGB['smsMalError3']() + '#report ' + usedPrefix + command, null, [[Error, `#reporte Reposrte este comando} *${usedPrefix + command}*`]], m)
...
console.log(`❗❗ errora algo salio mal} ${usedPrefix + command} ❗❗`)
console.log(e)	
}} 
handler.help = ['kick']
handler.tags = ['group']
